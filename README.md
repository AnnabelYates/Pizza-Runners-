...
Using MYSQL Workbench, I created a schema with 6 tables uploaded from CVC files. Using SQL, I cleaned and prepared my schema and tables for analysis including resolving null and missing values, correcting data types and ensuring consistency and connections across the entire schema. 
...
- I simplified the reasons for cancellation in runner_orders to restaurant and customer. 
  ...
  - I removed the measurement units from the values within the distance and duration columns of the runner_orders table.
...
- To clarify the measurement units for the distance and duration columns of the runner_orders table, I renamed these two columns to distance_km and duration_min.
